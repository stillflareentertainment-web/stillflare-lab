...
Contributions are welcome in the form of **feedback, ideas, and respectful discussion**, but code changes are tightly controlled to protect the integrity and scope of the system.
...
At this time, **direct code contributions (pull requests)** are:

- **By invitation only**
- Limited to small, focused changes such as:
  - UI polish
  - accessibility improvements
  - documentation fixes
  - clearly defined feature experiments

If you’d like to propose a code contribution:

1. Open an **Issue** with:
   - a clear description of the change,
   - why it’s useful for HR/operations,
   - and any risks or tradeoffs you see.
2. Wait for confirmation before opening a Pull Request.

Unsolicited PRs may be closed without review to keep the project focused and manageable.
...
MAAS-HR is designed as an **HR / Operations tool**, not a clinical instrument.
...
All contributions are made under the existing project license:
